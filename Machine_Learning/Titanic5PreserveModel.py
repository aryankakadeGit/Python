...
# Description   : preserves the model on secondary          
...
def PreserveModel(model,filename):
    ...
    print("Model reserved successfully with name : ",filename)

#__________________________________________________________
# Function Name : TrainTitanicModel
# Description   : does : split x,y,training ,testing data           
# Parameters    : df
# Return        : NONE
# Date          : 14/03/2026
# Author        : Aryan Hanumant Kakade 
...
def TrainTitanicModel(df):
    ...
    print("Intercept of model (c) : "+model.intercept_)
    print("Coefficient :")
    for feature , coeffiecient in zip(X.column,model.coef_[0]):
        print(feature + ":" +coeffiecient)
...
def MarvellousTitanicLogistic(Datapath):
    ...
    df = CleanTitanicData(df,"Data cleaning")
